...
parcelRequire = function (modules, cache, entry, globalName) {
    ...
    r.prototype.setup = function () {
      ...
      return new Promise(function (r) {
        try {
          ...
          return e.update(), e.onEnter && e.onEnter(), Promise.resolve(e.Transition ? Promise.resolve(e.Transition.show(t)).then(_i2) : _i2());
        } catch (t) {
      ...
      return new Promise(function (r) {
        try {
          var _i3 = function _i3(t) {
            e.onLeaveCompleted && e.onLeaveCompleted(), r();
          };

          return e.onLeave && e.onLeave(), Promise.resolve(e.Transition ? Promise.resolve(e.Transition.hide(t)).then(_i3) : _i3());
        } catch (t) {
          return Promise.reject(t);
        }
      });
    ...
    var Fade = /*#__PURE__*/function (_Highway$Transition) {
      ...
      _createClass(Fade, [{
        ...
        value: function _in(_ref) {
          var from = _ref.from,
              to = _ref.to,
              done = _ref.done; //Remove old content
  ...
  "js/scripts.js": [function (require, module, exports) {
    ...
    var links = document.querySelectorAll('header a'); //listen to the NAVIGATE_IN event
    ...
    H.on('NAVIGATE_IN', function (_ref) {
      ...
      links.forEach(function (link) {
        ...
        link.classList.remove('is-active'); //add the active class
...
//# sourceMappingURL=scripts.b9ff4c88.js.map